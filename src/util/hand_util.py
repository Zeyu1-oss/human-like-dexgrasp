    ...
    def __init__(
        ...
        if debug_viewer:
            try:
                ...
                print("[INFO] Viewer launched successfully. Close the window to continue.")
                while self.debug_viewer.is_running():
                    self.debug_viewer.sync()
            except Exception as e:
                print("[WARN] Viewer initialization failed:", e)
                self.debug_viewer = None
        ...
        if debug_render:
            try:
                ...
                print("[WARN] Renderer initialization failed:", e)
                self.debug_render = None
