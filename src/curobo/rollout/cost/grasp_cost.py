...
class GraspCost(CostBase, GraspCostConfig):
    ...
    def loss_w_ge(self, pos, dist, normal, contact_distance, opt_progress):# qp energy
    ...
    def forward(self, robot_sphere_in, link_pos_quat, env_query_idx, opt_progress):
        ...
        if self.contact_query_mode == -1:# 
            ...
            strength_sample = self.perturb_strength_generator.get_samples(b*h*n_points, bounded=True)# b=800 h=1 n_points=5
